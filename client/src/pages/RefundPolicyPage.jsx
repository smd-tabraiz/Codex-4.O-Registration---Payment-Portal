...
const REFUND_SECTIONS = [
  {
    ...
    paragraphs: [
      'Codex 4.0 is an on-campus technical competition organized by Coders\' Club, GPREC, with a capped participant capacity (limited up to 150 teams) and substantial upfront logistical commitments (up to ₹50,000 INR prize pool allocation, laboratory reservations, catering, certificates, and infrastructure).',
