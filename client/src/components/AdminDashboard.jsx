...
const AdminDashboard = ({ adminToken, adminSecret, onLogout }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      {/* ── TOP HEADER BAR ────────────────────────────── */}
      <div className="bg-[#0D0D0D] text-white rounded-xl p-5 flex flex-col lg:flex-row lg:items-center justify-between gap-5 shadow-sm">
        <div className="flex items-center gap-4">
          <div className="w-11 h-11 rounded-lg bg-[#E64B2E] flex items-center justify-center shadow-sm shrink-0">
            <ShieldCheck className="w-6 h-6 text-white" />
          </div>
          <div>
            <div className="flex items-center gap-3 flex-wrap">
              <h1 className="text-xl font-bold tracking-tight">Tabraiz Admin Dashboard</h1>
              <span className="text-[10px] font-semibold bg-[#E64B2E]/20 text-[#E64B2E]/70 px-2.5 py-0.5 rounded-full border border-[#E64B2E]/50/30 uppercase tracking-wider">
            ...
            <p className="text-xs text-[#D6D3CF] mt-0.5 font-normal">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button
            ...
            className={`px-3.5 py-2 rounded-lg border text-xs font-medium flex items-center gap-2 transition-all disabled:opacity-50 ${
              underConstruction
                ...
                : 'bg-[#1a1a1a] text-slate-300 border-slate-700 hover:bg-slate-700'
            }`}
          ...
          <a
            ...
            className="px-3 py-2 rounded-lg bg-[#E64B2E]/30 hover:bg-[#c73d21]/40 text-[#E64B2E]/50 border border-[#E64B2E]/50/40 text-xs font-semibold flex items-center gap-1.5 transition-all"
          >
            <FileSpreadsheet className="w-4 h-4 text-[#E64B2E]/70" />
            Open Sheet
          ...
          <button
            ...
            disabled={loading}
            className="p-2 rounded-lg bg-[#1a1a1a] hover:bg-slate-700 text-slate-300 border border-slate-700 transition-all disabled:opacity-40"
            title="Refresh"
          >
          ...
          <button
            onClick={onLogout}
            className="px-3.5 py-2 rounded-lg bg-[#1a1a1a] hover:bg-rose-900/40 text-slate-300 hover:text-rose-300 border border-slate-700 hover:border-rose-500/40 text-xs font-semibold flex items-center gap-2 transition-all"
          >
      ...
      <div className="bg-white rounded-xl border border-[#D6D3CF] shadow-card p-5">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h2 className="text-base font-bold text-[#0D0D0D]">Event Registration Fee Control</h2>
      ...
      <div className="bg-white rounded-xl border border-[#D6D3CF] shadow-card p-5">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2.5">
              <div className="p-2 rounded-lg bg-[#fdf1ee] text-[#E64B2E]">
                <Trophy className="w-5 h-5" />
              </div>
              <div>
                <h2 className="text-base font-bold text-[#0D0D0D]">Event Team Capacity Control</h2>
                <p className="text-xs text-[#9A9A9A]">
          ...
          <div className="flex items-center gap-2 self-start md:self-auto bg-slate-50 border border-slate-200 px-3.5 py-1.5 rounded-lg">
            ...
            <span className="text-sm font-extrabold text-[#E64B2E] font-mono">{registrationCap} Teams</span>
          </div>
        </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative rounded-lg shadow-xs max-w-[140px]">
              <input
                ...
                placeholder="200"
                className="block w-full px-3 py-1.5 text-sm font-bold text-slate-900 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#E64B2E] focus:border-[#E64B2E]"
              />
            </div>
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-lg bg-[#E64B2E] hover:bg-[#c73d21] text-white text-xs font-bold flex items-center gap-1.5 shadow-xs transition-all disabled:opacity-50"
            >
              {savingCap ? (
                <>
                  <Loader2 className="w-3.5 h-3.5 animate-spin" />
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-md text-xs font-semibold border transition-all ${
                  registrationCap === preset
                    ? 'bg-[#fdf1ee] text-[#E64B2E] border-[#E64B2E]/40 font-bold shadow-xs'
                    : 'bg-slate-50 hover:bg-slate-100 text-slate-600 border-slate-200'
                }`}
              >
                {preset} Teams
        ...
        {/* Success Feedback */}
        {capSuccess && (
          <div className="mt-3 flex items-center gap-2 p-2.5 bg-[#fdf1ee] border border-[#E64B2E]/30 text-[#0D0D0D] rounded-lg text-xs font-semibold animate-fade-in-up">
            <CheckCircle2 className="w-4 h-4 text-[#E64B2E] shrink-0" />
      ...
      {stats && (
        <>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Teams Registered */}
            <div className="bg-white p-5 rounded-xl border border-[#D6D3CF] shadow-card flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-semibold text-[#9A9A9A] uppercase tracking-wider">Teams Registered</span>
                <div className="p-2 rounded-lg bg-[#fdf1ee] text-[#E64B2E]"><Trophy className="w-4 h-4" /></div>
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-3xl font-extrabold text-[#0D0D0D]">{stats.paidTeamsCount}</span>
                <span className="text-[#9A9A9A] text-sm font-medium">/ {stats.registrationCap}</span>
              </div>
              <div>
                <div className="flex justify-between text-[10px] font-medium text-[#9A9A9A] mb-1">
                ...
                <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                  <div
                    className={`h-full rounded-full transition-all duration-700 ${spotsLeft <= 10 ? 'bg-rose-500' : 'bg-[#E64B2E]'}`}
                    style={{ width: `${fillPct}%` }}
                  />
                </div>
              </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-[#D6D3CF] shadow-card flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-semibold text-[#9A9A9A] uppercase tracking-wider">Revenue Collected</span>
              ...
              <div className="flex items-center gap-1.5 text-xs text-[#9A9A9A] font-normal">
            ...
            <div className="bg-white p-5 rounded-xl border border-[#D6D3CF] shadow-card flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <span className="text-[11px] font-semibold text-[#9A9A9A] uppercase tracking-wider">Total Participants</span>
              ...
              <div className="text-xs text-[#9A9A9A] font-normal">Across all paid teams</div>
            </div>

            {/* Year-wise */}
            <div className="bg-white p-5 rounded-xl border border-[#D6D3CF] shadow-card flex flex-col gap-2">
              <div className="flex items-center justify-between mb-1">
                <span className="text-[11px] font-semibold text-[#9A9A9A] uppercase tracking-wider">Year-wise Split</span>
              ...
              <div className="grid grid-cols-4 gap-1.5 text-center">
                {['1st','2nd','3rd','4th'].map((yr) => (
                  <div key={yr} className="bg-[#F2F2F2] p-2 rounded-lg border border-[#D6D3CF]">
                    <div className="text-[10px] text-[#9A9A9A] font-semibold mb-1">{yr}</div>
                    <div className={`font-extrabold text-base ${yr === '4th' ? 'text-amber-700' : 'text-[#0D0D0D]'}`}>
            ...
            {[
              ...
              <div key={label} className={`bg-white p-4 rounded-xl border ${bg} shadow-card flex items-center gap-4`}>
                ...
                <div>
                  ...
                  <div className="text-[11px] text-[#9A9A9A] font-semibold uppercase tracking-wider">{label} Registrations</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* ── FILTER + SEARCH ───────────────────────────── */}
      <div className="bg-white p-4 rounded-xl border border-[#D6D3CF] shadow-card flex flex-col sm:flex-row items-center justify-between gap-3">
        <form onSubmit={handleSearchSubmit} className="w-full sm:w-80 flex items-center gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-xl bg-white border border-[#D6D3CF] text-xs text-[#0D0D0D] placeholder-[#94A3B8] focus:outline-none focus:border-[#E64B2E] focus:ring-2 focus:ring-blue-100 transition-colors"
            />
          </div>
          <button
            type="submit"
            className="px-4 py-2 rounded-xl bg-[#E64B2E] hover:bg-[#c73d21] text-white text-xs font-semibold transition-all shadow-xs"
          >
            Search
          </button>
        </form>
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-xs font-semibold uppercase tracking-wider transition-all border ${
              statusFilter.length === 0
                ? 'bg-[#0D0D0D] text-white border-[#0D0D0D] shadow-xs'
                : 'bg-white text-[#9A9A9A] hover:text-[#0D0D0D] border-[#D6D3CF]'
            }`}
          >
            All
          </button>
            ...
            return (
              ...
              >
                <input
                  ...
                  className="w-3.5 h-3.5 rounded text-[#E64B2E] focus:ring-0 cursor-pointer pointer-events-none"
                />
                {f}
              </button>
            );
      ...
      {/* ── REGISTRATIONS TABLE ───────────────────────── */}
      <div className="bg-white rounded-xl border border-[#D6D3CF] overflow-hidden shadow-card">
        {/* Table Header */}
        <div className="px-5 py-4 border-b border-[#D6D3CF] flex items-center justify-between bg-[#F2F2F2]">
          <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="text-[11px] text-[#9A9A9A] font-medium hidden sm:block">
            Click any row to expand member details
          </span>
        </div>

        {loading ? (
          <div className="p-16 text-center flex flex-col items-center gap-3 text-[#9A9A9A]">
            <Loader2 className="w-8 h-8 animate-spin text-[#E64B2E]" />
            <span className="text-sm font-medium">Loading registrations...</span>
          </div>
        ) : registrations.length === 0 ? (
          <div className="p-16 text-center text-[#9A9A9A] flex flex-col items-center gap-2">
            <Users className="w-10 h-10 text-slate-300" />
            <p className="font-semibold text-[#0D0D0D]">No registrations found</p>
            <p className="text-xs">Try changing the filter or search term</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs sm:text-sm">
              <thead className="bg-[#F2F2F2] text-[#9A9A9A] font-semibold uppercase tracking-wider text-[10px] border-b border-[#D6D3CF]">
                <tr>
                ...
                {registrations.map((reg) => {
                  ...
                  return (
                    <React.Fragment key={reg._id}>
                      <tr
                        className={`hover:bg-slate-50 transition-colors cursor-pointer ${isExpanded ? 'bg-[#fdf1ee]/30' : ''}`}
                        onClick={() => setExpanded(isExpanded ? null : reg._id)}
                      >
                        {/* Team */}
                        <td className="px-5 py-4">
                          <div className="font-mono font-bold text-[#E64B2E] text-xs">{reg.teamId}</div>
                          <div className="font-bold text-[#0D0D0D] text-sm mt-0.5">{reg.teamName}</div>
                        </td>

                        {/* Leader */}
                        <td className="px-5 py-4">
                          <div className="font-semibold text-[#0D0D0D]">{leader?.name}</div>
                          <div className="text-[11px] text-[#9A9A9A] mt-0.5">{leader?.email}</div>
                          <div className="text-[11px] text-[#9A9A9A] font-mono">{leader?.rollNo}</div>
                        </td>

                        {/* Member count */}
                        <td className="px-5 py-4 text-center">
                          <span className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-slate-100 text-[#0D0D0D] font-bold text-sm border border-[#D6D3CF]">
                          ...
                          {editingStatusId === reg._id ? (
                            <div className="flex items-center gap-1.5">
                              <select
                                ...
                                className="bg-white border border-[#E64B2E] text-[#0D0D0D] text-xs rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-100 font-medium"
                              >
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-[#9A9A9A] border border-[#D6D3CF] transition-all"
                                title="Cancel"
                              >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                className="p-1 rounded-lg bg-slate-100 hover:bg-[#fdf1ee] text-[#9A9A9A] hover:text-[#E64B2E] border border-[#D6D3CF] transition-all"
                                title="Edit status"
                              >
                        ...
                        {/* Payment */}
                        <td className="px-5 py-4">
                          <div className="font-mono text-[11px] text-[#9A9A9A] max-w-[120px] truncate" title={reg.paymentDetails?.cfPaymentId || reg.paymentDetails?.razorpayPaymentId}>
                        ...
                        {/* Paid On — date + time */}
                        <td className="px-5 py-4">
                          <div className="flex flex-col gap-0.5 text-[11px] text-[#9A9A9A]">
                            <div className="flex items-center gap-1.5">
                              <Calendar className="w-3.5 h-3.5 shrink-0 text-[#9A9A9A]" />
                          ...
                          <div className="flex items-center justify-end gap-2">
                            {reg.status === 'paid' && (
                              <button
                                ...
                                className="p-2 rounded-lg bg-[#fdf1ee] hover:bg-[#fbe4de] text-[#E64B2E] border border-[#E64B2E]/30 transition-all disabled:opacity-40"
                            ...
                            <button
                              onClick={() => setExpanded(isExpanded ? null : reg._id)}
                              className="p-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-[#0D0D0D] border border-[#D6D3CF] transition-all"
                      ...
                      {isExpanded && (
                        <tr className="bg-[#F2F2F2]">
                          <td colSpan={7} className="px-5 py-5 border-t border-[#D6D3CF]">
                            <div className="space-y-4">
                              {/* Panel header */}
                              <div className="flex items-center justify-between flex-wrap gap-2">
                                <h5 className="text-xs font-bold uppercase tracking-wider text-[#E64B2E] flex items-center gap-2">
                                ...
                                {reg.members?.map((m, idx) => (
                                  <div
                                    ...
                                    className={`p-4 rounded-xl border text-xs space-y-2.5 ${
                                      m.isLeader
                                        ? 'bg-[#fdf1ee]/70 border-[#E64B2E]/30'
                                        : 'bg-white border-[#D6D3CF]'
                                    }`}
                                  >
                                    <div className="flex items-center justify-between">
                                      <div className="font-bold text-[#0D0D0D] text-sm">{m.name}</div>
                                      {m.isLeader && (
                                        <span className="text-[9px] font-bold bg-[#E64B2E] text-white px-2 py-0.5 rounded-full uppercase tracking-wider">
                                          Leader
                                        </span>
                                      )}
                                    </div>
                                    <div className="grid grid-cols-2 gap-y-2 text-[#9A9A9A]">
                                      <div className="flex items-center gap-1.5 col-span-2 font-mono text-[11px] break-all text-[#0D0D0D]">
                                        <User className="w-3 h-3 shrink-0 text-[#9A9A9A]" />
                                        {m.email}
                                      </div>
                                      <div className="flex items-center gap-1.5">
                                        <Hash className="w-3 h-3 text-[#9A9A9A]" />
                                        <span className="font-mono text-[#0D0D0D]">{m.rollNo || '—'}</span>
                                      </div>
                                      <div className="flex items-center gap-1.5">
                                      ...
                                      <div className="flex items-center gap-1.5">
                                        <Building2 className="w-3 h-3 text-[#9A9A9A]" />
                                        <span>{m.branch}</span>
                                      </div>
                                    </div>
                                    <div className="text-[10px] text-[#9A9A9A] border-t border-[#D6D3CF] pt-1.5">
                                      {m.college || 'GPREC'}
                                    </div>
                                  </div>
                                ))}
        ...
        {!loading && registrations.length > 0 && (
          <div className="px-5 py-3 border-t border-[#D6D3CF] bg-[#F2F2F2] flex items-center justify-between text-[11px] text-[#9A9A9A] font-medium">
